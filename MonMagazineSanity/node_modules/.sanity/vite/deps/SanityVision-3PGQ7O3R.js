...
import {
  javascriptLanguage
} from "./chunk-N6MJZ34Z.js";
import {
  closeBrackets
} from "./chunk-LETVB5UL.js";
import "./chunk-D3RZKVLD.js";
import {
  EditorSelection,
  EditorView,
  HighlightStyle,
...
function VisionGui(props) {
  const {
  ...
  }, [localStorage2]), handleKeyDown = (0, import_react2.useCallback)((event) => {
  ...
  }, [params.valid, handleQueryExecution]), handlePaste = (0, import_react2.useCallback)((evt_4) => {
    var _a, _b;
    ...
    evt_4.preventDefault(), setDataset(finalState.dataset), setQuery(finalState.query), setParams({
      ...
      valid: true,
      error: void 0
    }), setApiVersion(finalState.apiVersion), finalState.customApiVersion && setCustomApiVersion(finalState.customApiVersion), setPerspectiveState(finalState.perspective), (_a = editorQueryRef.current) == null ? void 0 : _a.resetEditorContent(finalState.query), (_b = editorParamsRef.current) == null ? void 0 : _b.resetEditorContent(finalState.rawParams), localStorage2.merge({
  ...
  return (0, import_react2.useEffect)(() => {
  ...
  }, [perspectiveStack]), (0, import_jsx_runtime2.jsxs)(Root, { direction: "column", height: "fill", ref: visionRootRef, sizing: "border", overflow: "hidden", "data-testid": "vision-root", children: [
    ...
    (0, import_jsx_runtime2.jsx)(SplitpaneContainer, { flex: "auto", children: (0, import_jsx_runtime2.jsxs)(
      SplitPane,
      {
...
function VisionContainer(props) {
  ...
  let t3;
  return $[10] !== datasets || $[11] !== defaultDataset || $[12] !== projectId || $[13] !== props ? (t3 = (0, import_react2.createElement)(VisionGui, { ...props, key: projectId, datasets, projectId, defaultDataset }), $[10] = datasets, $[11] = defaultDataset, $[12] = projectId, $[13] = props, $[14] = t3) : t3 = $[14], t3;
}
...
doc-path/lib/path.js:
   ...
   *)
*/
//# sourceMappingURL=SanityVision-3PGQ7O3R.js.map
